...
function VideoDetails (props) {
    ...
    const fullDate = new Date(props.mainVideo.timestamp)
        ...
        <h1 className = 'video__title'>{props.mainVideo.title}</h1>
            <div className = 'video__data'>
                <div className = 'video__data-left'>
                    <h3 className = 'video__data-channel'>By {props.mainVideo.channel}</h3>
                ...
                <div className = 'video__data-right'>
                    <div className = 'video__data-icon'>
                        ...
                        <span className = 'video__data-views'>{props.mainVideo.views}</span>
                    </div>
                    <div className = 'video__data-likes'>
                        <img className = 'video__likes-icon' src = {likeIcon}></img>
                        <span className = 'video__data-likes'>{props.mainVideo.likes}</span>
                    </div>
                </div>
            </div>
