...
function VideoDetails (props) {
    ...
    const fullDate = new Date(props.currentVideo.timestamp)
        ...
        <h1 className = 'video__title'>{props.currentVideo.title}</h1>
            <div className = 'video__data'>
                <div className = 'video__data-left'>
                    <h3 className = 'video__data-channel'>By {props.currentVideo.channel}</h3>
                ...
                <div className = 'video__data-right'>
                    <div className = 'video__data-icon'>
                        ...
                        <span className = 'video__data-views'>{props.currentVideo.views}</span>
                    </div>
                    <div className = 'video__data-likes'>
                        <img className = 'video__likes-icon' src = {likeIcon}></img>
                        <span className = 'video__data-likes'>{props.currentVideo.likes}</span>
                    </div>
                </div>
            </div>
