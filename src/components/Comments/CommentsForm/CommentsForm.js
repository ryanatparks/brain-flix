    ...
    return (
        <section className = "comment">
            ...
            <div className = "comment__container-wrap">
                <img className =  'comment__avatar-image' src = 'http://localhost:8080/images/Mohan-muruge.jpg' alt = 'Comment box avatar icon'></img>
                <form id = 'comment__form'>
                    ...
                    <textarea id = 'comment' placeholder = 'Add a new comment' name = 'comments'></textarea>
                        <div className = "comment__button-container">
                            <img className = "comment__button-icon" src = 'http://localhost:8080/Icons/add_comment.svg' alt = 'Add comment button icon'></img>
